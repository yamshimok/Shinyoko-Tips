...
<html lang="en">
  ...
  <meta name="request-id" content="EE8E:8F88:4CF5FC:6ECB72:5C6ABA88" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="EE8E:8F88:4CF5FC:6ECB72:5C6ABA88" /><meta name="octolytics-dimension-region_edge" content="sea" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR,MARKETPLACE_BROWSING_V2">

  <meta name="html-safe-nonce" content="0930712813a60f07ed4a82e0905e55555322247b">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="25095239" data-scoped-search-url="/aFarkas/lazysizes/search" data-unscoped-search-url="/search" action="/aFarkas/lazysizes/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=k9Fdl8lNKDXHy9CyTgcq0qxB2Ip/W0TMubf0unHk8NEBYlT3CWyguMiLepRcutTC6Hiwu0BwZ64RtE5MvnNXeQ=="
          spellcheck="false"
          autocomplete="off"
          >
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="">
    ...
    <div aria-hidden="true" class="border rounded-1 flex-shrink-0 bg-gray px-1 text-gray-light ml-1 f6 d-none d-on-nav-focus js-jump-to-badge-jump">
      ...
      <span class="d-inline-block ml-1 v-align-middle">↵</span>
        ...
        <a class="HeaderMenu-link no-underline mr-3" href="/login?return_to=%2FaFarkas%2Flazysizes%2Fblob%2Fgh-pages%2Flazysizes.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign&nbsp;in</a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/aFarkas/lazysizes/stargazers"
      aria-label="10148 users starred this repository">
      10,148
    </a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/aFarkas/lazysizes/blob/27ff2adf5ba6548297f252115744e1ef49ba4af9/lazysizes.min.js">Permalink</a>

    <!-- blob contrib key: blob_contributors:v21:09f2a9bebe1b36556457967b5378ff24 -->

        <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="DxnlZSWplkX5vVtqn4bRKb81vSNE/4iI+s+CdwARe59+O1/BrJit741F36UvCSt+HV2C5fxEQJ0WvSrp0lFK/A==" />
...
<details class="details-reset details-overlay select-menu branch-select-menu float-left">
  ...
  <details-menu class="select-menu-modal position-absolute" style="z-index: 99;" src="/aFarkas/lazysizes/ref-list/gh-pages/lazysizes.min.js?source_action=show&amp;source_controller=blob" preload>
    <include-fragment class="select-menu-loading-overlay anim-pulse">
      ...
      <div id="blob-path" class="breadcrumb">
        <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/aFarkas/lazysizes"><span>lazysizes</span></a></span></span><span class="separator">/</span><strong class="final-path">lazysizes.min.js</strong>
      </div>
    </div>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/aFarkas/lazysizes/commit/27ff2adf5ba6548297f252115744e1ef49ba4af9" data-pjax>
          27ff2ad
        </a>
        <relative-time datetime="2019-02-15T12:36:01Z">Feb 15, 2019</relative-time>
      </span>
      <div>
        ...
        <a class="user-mention" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=188254" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/aFarkas">aFarkas</a>
          <a data-pjax="true" title="4.1.6" class="message" href="/aFarkas/lazysizes/commit/27ff2adf5ba6548297f252115744e1ef49ba4af9">4.1.6</a>
      </div>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2" style="width:185px">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/aFarkas/lazysizes/blame/27ff2adf5ba6548297f252115744e1ef49ba4af9/lazysizes.min.js">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2019 <span title="0.27098s from unicorn-7d68979947-6l6m5">GitHub</span>, Inc.</li>
